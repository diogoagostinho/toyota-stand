    ...
    <>
      {car.map((item: any) => (
        <div key={item.nameId}>
          ...
          <div className="flex flex-col justify-center gap-14 pb-10">
            <div className="flex justify-center gap-10">
              ...
              <div>
                ...
                <p className="font-normal text-lg pt-4 max-w-xl">
          ...
          <div className="py-8 mb-10 bg-foreground-100">
          ...
          <div className="px-20 flex flex-col justify-center items-center">
            ...
            <p className="text-md pt-3">Starting at:</p>
            <div className="flex flex-col justify-center gap-6 text-lg w-[600px] py-10">
